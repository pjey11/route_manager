...
export async function sendGroupMessage(message: string): Promise<{ success: boolean; error?: string }> {
  if (!MAKE_WEBHOOK_URL) {
    logger.warn("MAKE_WEBHOOK_URL not configured — WhatsApp group message not sent");
